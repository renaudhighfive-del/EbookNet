  ...
  <AdminLayout>
    ...
    <template v-else>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-4 mb-8">
        ...
        >
          <div
            class="w-10 h-10 bg-[#EEF1F7] rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#1B2A4A] transition-colors"
          >
        ...
        <div
          class="bg-white rounded-2xl p-5 border-l-4 border-l-amber-400 border border-amber-100 shadow-sm hover:shadow-md transition-shadow"
        >
        ...
        >
          <div
            class="w-10 h-10 bg-teal-50 rounded-xl flex items-center justify-center mb-4 group-hover:bg-teal-500 transition-colors"
          >
        ...
        >
          <div
            class="w-10 h-10 bg-[#EEF1F7] rounded-xl flex items-center justify-center mb-4 group-hover:bg-teal-500 transition-colors"
          >
        ...
        >
          <div
            class="w-10 h-10 bg-sky-50 rounded-xl flex items-center justify-center mb-4 group-hover:bg-sky-500 transition-colors"
          >
        ...
        <div
          class="bg-white rounded-2xl p-5 border-l-4 border-l-red-400 border border-red-100 shadow-sm hover:shadow-md transition-shadow"
        >
          ...
          <div class="divide-y divide-gray-50">
            ...
            >
              ...
              <span
                ...
                class="text-[11px] font-medium px-2.5 py-1 rounded-full shrink-0 whitespace-nowrap"
              >
...
async function loadDashboard() {
  ...
  try {
    await Promise.all([
      ...
      api.get('/admin/stats/deposits-by-month').then((r) => {
        depositsByMonth.value = r.data
      }),
      api.get('/admin/stats/references-by-category').then((r) => {
        referencesByCategory.value = r.data
      }),
      api
        .get('/admin/deposits?status=pending,approved_by_manager,rejected_by_manager&per_page=5')
        .then((r) => {
          pendingDeposits.value = r.data.data ?? r.data
        }),
      api.get('/admin/activity-logs?per_page=8').then((r) => {
        activityLogs.value = r.data.data ?? r.data
      }),
    ])
  } catch (e) {
    hasError.value = true
