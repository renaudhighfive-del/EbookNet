...
async function submitAction(appointment = null) {
  ...
  try {
    ...
    if (result.email_sent === false) {
      ...
      toastStore.success(
        `Rendez-vous de ${target.first_name} ${status === 'confirmed' ? 'confirmé' : 'refusé'}.`,
      )
    }
  } catch {
      ...
      <div class="flex gap-2">
        ...
        >
          ...
          <span
            ...
            class="ml-1 w-5 h-5 inline-flex items-center justify-center rounded-full text-xs"
            :class="activeFilter === filter.id ? 'bg-white/20' : 'bg-gray-100 text-gray-500'"
          >
      ...
      >
        <div class="flex items-center gap-4">
          <div
            ...
            :style="{
              backgroundColor: getInitialsBg(`${appointment.first_name} ${appointment.last_name}`),
            }"
          >
