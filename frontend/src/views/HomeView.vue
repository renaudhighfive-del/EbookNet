  ...
  <PublicLayout>
    <div class="flex-1 flex flex-col">
      ...
      <template v-else>
        <!-- Hero Section -->
        <section
          class="relative bg-linear-to-b from-[#1B2A4A] via-[#1B2A4A] to-[#0D6B76] overflow-hidden"
        >
          ...
          <div class="relative max-w-6xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            <div class="text-center">
              <div class="mb-6">
                <span
                  class="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 text-xs text-white/80 font-medium"
                >
              ...
              <h1
                class="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white mb-6 leading-tight"
              >
              ...
              <p class="text-slate-300 text-base max-w-2xl mx-auto mb-10 leading-relaxed">
                {{ stats.total_references.toLocaleString('fr-FR') }} références académiques,
                mémoires et thèses disponibles en ligne pour étudiants, chercheurs et
                professionnels.
              </p>
              ...
              <div class="max-w-2xl mx-auto mb-8">
                ...
                >
                  ...
                  <span class="flex-1 px-3 py-3 text-slate-400 text-sm text-left"
                    >Cliquez ici sur la bouton pour rechercher toutes les références
                    publiées...</span
                  >
                  <span
                    class="bg-[#1B2A4A] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#0F1322] transition-all duration-300 text-sm cursor-pointer"
                  >
                    Rechercher
                  </span>
                </router-link>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div class="p-4">
                <div class="flex items-center justify-center gap-3">
                  <div
                    class="w-10 h-10 bg-[#F2F4F9] rounded-xl flex items-center justify-center text-[#1B2A4A]"
                  >
                    <BookOpen class="w-5 h-5" />
                  </div>
                  <div class="text-left">
                    <div class="text-2xl font-mono font-bold text-[#1B2A4A] mb-0.5">
                      {{ stats.total_references.toLocaleString('fr-FR') }}
                    </div>
                    <div class="text-slate-500 text-[10px] uppercase tracking-wide font-semibold">
                      Références
                    </div>
                  </div>
                </div>
              ...
              <div class="p-4">
                <div class="flex items-center justify-center gap-3">
                  ...
                  <div class="text-left">
                    <div class="text-2xl font-mono font-bold text-[#1B2A4A] mb-0.5">
                      {{ stats.total_authors.toLocaleString('fr-FR') }}
                    </div>
                    <div class="text-slate-500 text-[10px] uppercase tracking-wide font-semibold">
                      Auteurs
                    </div>
              ...
              <div class="p-4">
                <div class="flex items-center justify-center gap-3">
                  ...
                  <div class="text-left">
                    <div class="text-2xl font-mono font-bold text-[#1B2A4A] mb-0.5">
                      {{ stats.total_categories.toLocaleString('fr-FR') }}
                    </div>
                    <div class="text-slate-500 text-[10px] uppercase tracking-wide font-semibold">
                      Catégories
                    </div>
              ...
              <div class="p-4">
                <div class="flex items-center justify-center gap-3">
                  ...
                  <div class="text-left">
                    <div class="text-2xl font-mono font-bold text-[#1B2A4A] mb-0.5">
                      {{ stats.total_downloads.toLocaleString('fr-FR') }}
                    </div>
                    <div class="text-slate-500 text-[10px] uppercase tracking-wide font-semibold">
                      Téléchargements
                    </div>
        ...
        <section class="py-14 bg-[#F8F7F4]">
          <div class="max-w-6xl mx-auto px-6 lg:px-8">
            <div class="flex items-center justify-between mb-8">
              ...
              <router-link
                to="/catalogue"
                class="text-[#0D9488] font-medium hover:underline text-xs flex items-center gap-1"
              >
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              ...
              >
                <div
                  class="w-9 h-9 bg-[#F2F4F9] rounded-lg flex items-center justify-center text-[#1B2A4A] mb-3 group-hover:bg-[#ECFFFD] group-hover:text-[#0D9488] transition-all duration-300"
                >
        ...
        <section class="py-14 bg-[#F8F7F4]">
          <div class="max-w-6xl mx-auto px-6 lg:px-8">
            <div class="flex items-center justify-between mb-8">
              <h2 class="text-2xl font-serif font-bold text-[#1B2A4A]">
                Dernières références ajoutées
              </h2>
              <router-link
                to="/catalogue"
                class="text-[#0D9488] font-medium hover:underline text-xs flex items-center gap-1"
          ...
          <div class="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
              <div class="grid md:grid-cols-5">
                <div
                  class="md:col-span-2 aspect-4/3 bg-linear-to-br from-[#1B2A4A] to-[#1E3368] flex items-center justify-center relative overflow-hidden"
                >
                  <BookOpen class="w-20 h-20 text-white/10" />
                  <div class="absolute top-4 left-4">
                    <span
                      class="bg-[#E79F1F] text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wide flex items-center gap-1"
                    >
                ...
                <div class="md:col-span-3 p-8 flex flex-col justify-between">
                  <div>
                    <span
                      class="inline-block bg-[#ECFFFD] text-[#0D9488] px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wide mb-4"
                    >
                      {{ featured.category }}
                    </span>
                    ...
                    <p class="text-slate-600 mb-3 text-sm">
                      Par
                      <span class="text-[#1B2A4A] font-medium">{{
