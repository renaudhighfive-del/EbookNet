      ...
      <div v-else>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
          <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-soft">
            <div class="flex items-center gap-4">
              <div
                class="w-12 h-12 bg-teal-50 rounded-xl flex items-center justify-center text-[#0D9488]"
              >
                <BookOpen class="w-5 h-5" />
              </div>
              <div>
                <div class="text-2xl font-bold text-[#1B2A4A] font-mono">
          ...
          <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-soft">
            <div class="flex items-center gap-4">
              <div
                class="w-12 h-12 bg-[#F2F4F9] rounded-xl flex items-center justify-center text-[#1B2A4A]"
              >
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-soft">
            <h2 class="text-sm font-bold text-[#1B2A4A] uppercase tracking-wide mb-5">
              Activité récente
            </h2>
            <div class="space-y-4">
          ...
          <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-soft">
            ...
            <div class="space-y-2.5">
              ...
              >
                <div
                  class="flex items-center gap-3 text-sm text-[#1B2A4A] group-hover:text-[#0D9488]"
                >
...
function getActivityIconClass(type) {
  switch (type) {
    case 'view':
      return 'bg-teal-50 text-[#0D9488]'
    case 'download':
      return 'bg-[#F2F4F9] text-[#1B2A4A]'
    case 'deposit_accepted':
    case 'deposit_submitted':
...
function getActivityIconStyle(type) {
  switch (type) {
    case 'view':
      return { backgroundColor: '#EEFCF8', color: '#0D9488' }
    case 'download':
      return { backgroundColor: '#F2F4F9', color: '#1B2A4A' }
    case 'deposit_accepted':
    case 'deposit_submitted':
