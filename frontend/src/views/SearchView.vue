...
const searchResults = ref([
  {
    ...
    type: 'Livre',
    year: 2021,
    abstract: 'Cet ouvrage propose une analyse approfondie des principes du droit constitutionnel béninois.',
  },
  {
    id: 2,
      ...
      <div v-if="showAdvanced" class="bg-white rounded-2xl p-6 shadow-sm mb-8">
        ...
        <div class="mb-6">
          ...
          <div class="flex flex-wrap gap-3">
            <label class="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" checked class="rounded border-[#6B7280] text-[#0D9488] focus:ring-[#0D9488]">
            ...
            <label class="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" class="rounded border-[#6B7280] text-[#0D9488] focus:ring-[#0D9488]">
        ...
        <div class="grid sm:grid-cols-3 gap-4 mb-6">
          <div>
            ...
            <select class="w-full bg-[#F8F7F4] border border-[#E5E7EB] rounded-lg px-3 py-2 text-[#1A1A2E] focus:outline-none focus:ring-2 focus:ring-[#0D9488]">
        ...
        <div class="grid sm:grid-cols-4 gap-4 mb-6">
          <div>
            ...
            <input type="number" placeholder="1950" class="w-full bg-[#F8F7F4] border border-[#E5E7EB] rounded-lg px-3 py-2 text-[#1A1A2E] focus:outline-none focus:ring-2 focus:ring-[#0D9488]">
          </div>
          <div>
            <h4 class="text-sm font-medium text-[#1A1A2E] mb-2">à</h4>
            <input type="number" placeholder="2024" class="w-full bg-[#F8F7F4] border border-[#E5E7EB] rounded-lg px-3 py-2 text-[#1A1A2E] focus:outline-none focus:ring-2 focus:ring-[#0D9488]">
          </div>
          <div class="sm:col-span-2">
            <h4 class="text-sm font-medium text-[#1A1A2E] mb-2">Accès</h4>
            <div class="flex items-center gap-4 h-[42px]">
              <label class="flex items-center gap-2 cursor-pointer">
                <input type="radio" name="access" value="all" checked class="text-[#0D9488] focus:ring-[#0D9488]">
                <span class="text-[#6B7280]">Tous</span>
              </label>
              <label class="flex items-center gap-2 cursor-pointer">
                <input type="radio" name="access" value="public" class="text-[#0D9488] focus:ring-[#0D9488]">
                <span class="text-[#6B7280]">Public</span>
              </label>
              <label class="flex items-center gap-2 cursor-pointer">
                <input type="radio" name="access" value="registered" class="text-[#0D9488] focus:ring-[#0D9488]">
