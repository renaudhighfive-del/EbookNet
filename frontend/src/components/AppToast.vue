    ...
    <div class="fixed top-4 right-4 z-[100] flex flex-col gap-2 pointer-events-none">
      <TransitionGroup name="toast">
        <div
          ...
          :key="toast.id"
          :class="[
            'pointer-events-auto px-4 py-3 rounded-xl shadow-lg text-sm font-medium flex items-center gap-3 min-w-[320px] max-w-md',
        ...
        >
          ...
          <button @click="toastStore.toasts = toastStore.toasts.filter(t => t.id !== toast.id)" class="shrink-0 opacity-70 hover:opacity-100">
